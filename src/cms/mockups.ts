/**
 * Mockups produit (HTML figé, non éditable dans Puck au-delà du choix du
 * mockup) : décomposer ces visuels art-directed en blocs génériques serait
 * long et fragile — décision produit validée.
 *
 * Ils sont rendus en aria-hidden : ce sont des captures d'interface fictives,
 * un lecteur d'écran n'a rien à y gagner et réciterait des données d'exemple.
 */
