...
:root {
  ...
  --vigi-fond:    #FBF0D7;
  --vigi-txt:     #8A6206;
  /* Remonté de #8A94A0 (2,9:1 sur papier) : AA. */
  --fiche:        #616B75;
  /* Textes sur fond encre — les rgba() tombaient à 2,5:1. */
  --sur-encre:    #A8B4BE;
...
.qayed-landing .hero a:focus-visible,.qayed-landing footer a:focus-visible,.qayed-landing .cta-band a:focus-visible{outline-color:var(--cachet-sombre)}
...
/* :not(.btn) — sinon cette règle l'emportait sur .btn-primary et le bouton
   « Essayer gratuitement » s'affichait en encre sur violet (2,2:1). */
...
.qayed-landing .hero-ar{font-family:var(--font-ar);font-weight:700;font-size:19px;direction:rtl;text-align:right;color:var(--sur-encre-bas);margin-bottom:28px;opacity:0;animation:qLandFadeUp .6s .7s forwards}
...
.qayed-landing .mrz-icon{width:52px;height:52px;background:var(--cachet);border-radius:12px;display:flex;align-items:center;justify-content:center;margin:0 auto 12px;font-family:var(--font-m);font-size:13px;letter-spacing:.1em;color:#fff}
...
/* Rang de la carte en Archivo — la masse visuelle de l'ancienne pastille
   emoji, sans emoji. */
.qayed-landing .forqui-icon{font-family:var(--font-d);font-variation-settings:'wdth' 118;font-weight:900;font-size:30px;line-height:1;letter-spacing:-.02em;color:var(--cachet);margin-bottom:14px}
...
.qayed-landing .sec-icon{font-family:var(--font-m);font-size:13px;letter-spacing:.12em;color:var(--cachet-sombre);flex-shrink:0;margin-top:3px;min-width:22px}
...
.qayed-landing .feat-icon{width:46px;height:46px;border-radius:var(--r-sm);background:var(--cachet-dilue);display:flex;align-items:center;justify-content:center;font-family:var(--font-m);font-size:15px;letter-spacing:.06em;color:var(--cachet);margin-bottom:18px}
...
.qayed-landing .cta-sub{font-size:17px;color:rgba(255,255,255,.9);margin-bottom:36px;max-width:500px;margin-left:auto;margin-right:auto}
.qayed-landing .cta-meta{margin-top:20px;font-size:12px;color:rgba(255,255,255,.78);font-family:var(--font-m);letter-spacing:.1em}
...
.qayed-landing .footer-tagline{font-family:var(--font-ar);font-size:13px;direction:rtl;color:var(--sur-encre-bas);margin-bottom:16px}
.qayed-landing .footer-desc{font-size:14px;color:var(--sur-encre);line-height:1.6;max-width:270px}
/* h3 et non h4 : la séquence de titres sautait un niveau après les h2. */
.qayed-landing .footer-col h3{font-family:var(--font-m);font-size:10px;letter-spacing:.16em;text-transform:uppercase;color:var(--sur-encre-bas);margin-bottom:16px}
...
.qayed-landing .footer-legal{font-family:var(--font-m);font-size:11px;letter-spacing:.1em;color:var(--sur-encre-bas)}
...
/* L'état masqué n'est appliqué QUE si le script a posé .anim-ready : sans JS,
   ou si l'IntersectionObserver ne démarre pas, le contenu reste lisible. */
.qayed-landing.anim-ready .fade-in{opacity:0;transform:translateY(24px);transition:opacity .65s ease,transform .65s ease}
