...
/**
 * Seed initial : une ligne pour le modele actuellement utilise par le scan CIN et
 * le repli passeport (variable d'env CIN_SCAN_MODEL cote fonction Vercel, defaut
 * claude-sonnet-5).
 *
