...
/**
 * Un enregistrement par appel a l'API Anthropic (etape 1).
 *
 * Conformite INPDP (regle #3) : AUCUNE donnee personnelle du voyageur. Pas de nom,
 * pas de numero CIN, pas d'image, pas de payload. Uniquement des metadonnees
...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('ai_usage_events', function (Blueprint $table) {
            ...
            // Etablissement a l'origine du scan. Adapter le type si les PK ne sont
            // pas des bigint (uuid -> $table->foreignUuid(...)).
            $table->foreignId('establishment_id')->constrained('establishments')->cascadeOnDelete();

            // Utilisateur (operateur hotelier) ayant declenche le scan. Nullable :
            // resolu best-effort cote serveur, jamais le voyageur.
            ...
            // Index composites demandes par l'etape 1.
