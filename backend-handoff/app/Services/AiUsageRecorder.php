 ...
 *
 * Regle #4 : les prix ne sont jamais hardcodes ; ils viennent de la table ai_pricing.
 * Si aucun tarif actif n'existe pour le modele (ou prix a 0), le cout vaut 0.
 */
class AiUsageRecorder
{
    /**
     * @param  array{feature:string,establishment_id:mixed,user_id:?int,model:string,
    ...
    public function record(array $data): AiUsageEvent
    {
        ...
        return AiUsageEvent::create([
            ...
            'created_at' => isset($data['occurred_at'])
