...
export const fr = {
  ...
  notifications: {
    ...
    permissionBody:
      "Activez les notifications pour être alerté à chaque check-in, check-out et action de vos réceptionnistes, sur vos établissements.",
    permissionExamples: '✅ Check-in · 🔁 Check-out · ✏️ Fiche modifiée · ⚠️ Fiche non validée',
